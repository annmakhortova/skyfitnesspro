...
const coursesSlice = createSlice({
  ...
  initialState: {
    ...
    currentWorkout: {
      _id: "mrhuag",
      exercises: [{name:'Округляем грудную клетку при выдохе (10 повторений)',quantity:10},{name:'Тянем левую руку в правую сторону (20 повторений)',quantity:20},{name:'Тянем правую руку в левую сторону (20 повторений)',quantity:20}],
